...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($phone_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO users (phone_number, password) VALUES (?, ?)";
         
        if($stmt = mysqli_prepare($conn, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ss", $param_phone, $param_password);
    ...
    <div class="form-container fade-in">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
                ...
                <small class="form-text">Phone number must start with 98 and must be 10 digits long.</small>
            </div>    
            <div class="form-group">
